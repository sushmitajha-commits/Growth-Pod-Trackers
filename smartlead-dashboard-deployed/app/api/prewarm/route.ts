...
function closedMonthsFrom(start: string): { from: string; to: string; label: string }[] {
  ...
  // Walk forward until we hit (but exclude) the current month
...
export async function GET(req: NextRequest) {
  ...
  // One month at a time, all four routes in parallel within a month.
  // This gives the DB a chance to breathe between months.
